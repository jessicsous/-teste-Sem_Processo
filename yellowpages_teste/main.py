...
pesquisa.send_keys('destists')
sleep(1)
pesquisa_cidade = driver.find_element_by_id('location')
pesquisa_cidade.clear()
pesquisa_cidade.send_keys('Los Angeles, CA')
pesquisa_cidade.submit()
sleep(1)
